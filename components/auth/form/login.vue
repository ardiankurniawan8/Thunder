...
<template>
  <div>
      ...
      <v-layout row wrap>
        <v-flex xs12 class='mb-2'>
          <!-- __________________________________________________  MODIFY HERE __________________________________________________ -->
          <v-btn flat block class='primary' @click="submit" v-if="!isSubmitting">Login</v-btn>
...
<script>
// ------------------------------ MODIFY HERE ----------------------------------
import GQL from '~/apollo/mutations/auth/Authenticate'
// ------------------------------ END MODIFY HERE ------------------------------
  ...
  computed: {
    ...
    transformedErrors: function () {
      let errors = {
        ...
        password: this.translate(this.errorMessages.password)
      }
      return errors
    }
    // ------------------------------ END MODIFY HERE ------------------------------
